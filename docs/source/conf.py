...
version = ebury_audit.__version__
# The full version, including alpha/beta/rc tags.
release = ebury_audit.__version__
...
texinfo_documents = [
  ('index', 'ebury-audit', u'Ebury Audit Documentation',
   ebury_audit.__author__, 'ebury-audit', ebury_audit.__description__,
   'Miscellaneous'),
]
